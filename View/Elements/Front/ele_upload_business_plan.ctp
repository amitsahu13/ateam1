...
<script type="text/javascript">
    ...
    // code for uploading user image end here
			...
			<?php //echo $this->Form->input('business_plan_doc', array('div'=>false, 'label'=>false, "class" => "TXT_rwndInPutRi with_Lrg",'type'=>'file'));?>
			  <a href='<?=SITE_URL?>/img/projects/model.pptx' style='float:left;padding-left:10px;margin-top:-15px; ' title= "Use our sample Business Model Canvas" > 
			   <img src='<?=SITE_URL?>/img/projects/bsicon.jpg' width="40px" >  </a>	
