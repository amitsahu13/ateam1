    ...
    jQuery(function($){
        ...
        new AjaxUpload(btnUpload, {		
            ...
            onSubmit: function(file, ext){
                ...
                if (! (ext && /^(doc|pdf|docx|xls|txt|pptx|png|jpeg|jpg|ppt|mppx|xlsx)$/.test(ext))){
                    // check for valid file extension
                   $('#status2').text('Only Doc, Pdf ,Docx ,xls, pptx or txt files are allowed.').addClass('errorTxt');
                    return false;
                }
