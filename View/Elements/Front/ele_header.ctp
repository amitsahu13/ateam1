				...
				<div class="SubMenuNav my_place" id="navigation-my_place">
				 	 ...
				 	 <? endif;?>  
						...
						<!--  ChatRoom  And WorkRoom Stacks -->  
						  <li><a href="<?=SITE_URL?>/Inbox/index/1">My Chatrooms 
						  	<?php  if (Inbox::getTotal($this->Session->read('Auth.User.id'),'0') > 0):?> 
                   <span style="padding: 1px 4px 0px 4px;"> <?   echo Inbox::getTotal($this->Session->read('Auth.User.id'),'0'); ?></span>
                   <? endif;?>  
						   </a></li>
						  <li><a href="<?=SITE_URL?>/Inbox/index/2">My Workrooms 
			...
			<?php   }
				...
				if ($this->Session->read('Auth.User.role_id') != 5 ){
							...
							?>	
							 	...
							 	<li><?php echo $this->Html->link('My Projects - Leader',array('controller'=>'projects','action'=>'my_project'));?></li>
               		<li>
							 <a href='<?=SITE_URL?>/jobs/my_job'>My Projects - Expert</a>
			...
			<?php   } ?>
                    	...
                    	<ul class="SubMenu">
							...
							foreach($footer_link as $key=>$value){
								if($value['Page']['parent_id'] == HOW_IT_WORKS){ ?>
                                 ...
                                 <li>
                                    <a href="http://www.ateam4adream.com/#stories">Stories</a>
				</li>
                                <li>
                                    <a href="http://www.ateam4adream.com/#what_is_ateam4adream">What is Ateam4ADream</a>
				</li>
                                <li>
                                    <a href="http://www.ateam4adream.com/#how_it_works">How it Works</a>
				</li>           
				...
				<div class="SubMenuNav aboutat4" id="navigation-aboutat4"> 
                    	<ul class="SubMenu">
                           ...
                           <li>
                                    <a href="http://www.ateam4adream.com/#about_us">About us</a>
				</li>
                                <li>
                                    <a href="#">Contact us</a>
				</li>
					...
					<!--  Server   Delice   -->		  
						...
						<div class="loginslidingDiv" id="show_hide_login" style="display:none;">
							<ul>
								...
								echo $this->Html->link('My user info',array('controller'=>'users','action'=>'userinfo_authenticate'),array('div'=>false,'class'=>$class));
					else 
								echo $this->Html->link('My user info',array('controller'=>'users','action'=>'userinfo_authenticate'),array('div'=>false,'class'=>$class));
