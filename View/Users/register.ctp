		...
		<?php 			
            ...
            <ul class="RegFrmFild">
              <li>
				...
				<?php  
					echo ($this->Form->input('role_id', array('type'=>'radio', 'options'=>Configure::read('App.Roles'), 'div'=>false,'legend'=>false, 'label'=>false,'class'=>'chckBX chkbx user_type', 'id'=>'user_role_id','style'=>'margin:0 6px 0 16px')));
				?>
				</div>
              </li>
               <li>
