 ...
 <script type="text/javascript"> 
  		jQuery(document).ready(function(){
  			...
  			jQuery.get("<?=SITE_URL?>/users/getProjectList",function(data){
  				...
  				var prolist='';
				for (var i in data) {
				prolist +="<option value='"+i+"' >"+data[i]+"</option> ";
				...
				//alert("<select class='custom_dropdown' name='project' id='project_list'><option> Select Project </option>"+prolist+"</select>");
			//document.getElementById("project_list1").innerHTML="<option> Select Project </option>"+prolist+"";
  			});
